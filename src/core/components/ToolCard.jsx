    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br from-accent-500/20 via-purple-500/20 to-pink-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                
                {/* Popular Badge */}
                {isPopular && (
                    <div className="absolute top-3 right-3 z-10">
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-gradient-to-r from-orange-500 to-pink-500 text-white text-xs font-bold shadow-lg">
                ...
                <div className="relative p-5 h-full flex flex-col">
                    ...
                    <div className="flex items-start gap-4 mb-4">
                        <div className={`
                            ...
                            ${isPopular 
                                ? 'bg-gradient-to-br from-accent-100 to-purple-100 dark:from-accent-900/50 dark:to-purple-900/50 border-2 border-accent-200 dark:border-accent-700' 
                ...
                <div className={`
                    absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-accent-500 via-purple-500 to-pink-500 
